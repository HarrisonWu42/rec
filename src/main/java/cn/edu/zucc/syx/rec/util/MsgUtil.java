...
public class MsgUtil {
    ...
    private static final String APP_KEY="44ee3076c5beb3f3effd2aa93ae89782";
    //网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
    private static final String APP_SECRET="81a292df5d5e";
    //随机数
...
//        nvps.add(new BasicNameValuePair("templateid", TEMPLATEID));
        ...
        String code = object.get("obj").toString();
        return code;
    }
}